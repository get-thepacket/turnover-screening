...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var isDataExist, i, category;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db_1.db.category.count()];
                case 1:
                    isDataExist = _a.sent();
                    if (isDataExist) {
                ...
                case 2:
                    ...
                    category = faker_1.faker.commerce.productName();
                    return [4 /*yield*/, db_1.db.category.create({
                            data: {
                                name: category
                            }
                        })];
